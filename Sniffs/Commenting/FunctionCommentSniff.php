 ...
 */
class ZL_Sniffs_Commenting_FunctionCommentSniff extends PEAR_Sniffs_Commenting_FunctionCommentSniff
{

	private $_magicFunctions = array('execute', 'loadData', );
	...
	public function process(PHP_CodeSniffer_File $phpcsFile, $stackPtr)
	{
		...
		if(in_array($phpcsFile->getDeclarationName($stackPtr), $this->_magicFunctions))
		{
			return;
		}
