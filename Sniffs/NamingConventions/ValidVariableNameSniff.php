 ...
 * @link      http://pear.php.net/package/PHP_CodeSniffer
 */
class ZL_Sniffs_NamingConventions_ValidVariableNameSniff extends PHP_CodeSniffer_Standards_AbstractVariableSniff
{
	...
	/**
	 * Filename tokens to ignore
	 *
	 * @var array
	 */
	private $_fileIgnore = array(
								'Model',
								);
    ...
    protected function processVariable(PHP_CodeSniffer_File $phpcsFile, $stackPtr)
    {
		...
		if($this->_isFileIgnored($phpcsFile->getFileName()))
		{
			return;
		}
        ...
        if ($tokens[$objOperator]['code'] === T_OBJECT_OPERATOR) {
			...
			{
				// we're not able to determine if var is from model so decide to omit checking object vars
				return true;
            }//end if
        }//end if
	 ...
	 * @return bool
	 */
	private function _isFileIgnored($fileName)
	{
		foreach ($this->_fileIgnore as $str)
		{
